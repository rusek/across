...
coverage:
	...
	echo 'import coverage;coverage.process_startup()' > `python -c 'import coverage,os.path; \
	    print(os.path.dirname(os.path.dirname(coverage.__file__)))'`/across-coverage-startup.pth
